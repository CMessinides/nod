import { isSlug, getIdFromSlug, makeSluggable } from "./slugs";
...
describe("makeSluggable", () => {
	it("adds a slug property to the provided instance", () => {
		class ClassWithSlug {
			constructor() {
				this.id = 1;
				this.title = "A title";
		...
		expect(new ClassWithSlug().slug).toBe("a-title--1");
	});
});
